...
BOOL    pt_windows_api_enum_processes(DWORD **ppProcessIds, DWORD *pBytesReturned);
BOOL    pt_windows_api_enum_process_modules(HANDLE hProcess, HMODULE **lpphModule, LPDWORD lpcbNeeded);
