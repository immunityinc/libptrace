...
#define PT_FACTORY_PROCESS_WINDOWS		1
#define PT_FACTORY_PROCESS_WINDOWS_WOW64	2

#define PT_FACTORY_THREAD_WINDOWS		1
#define PT_FACTORY_THREAD_WINDOWS_WOW64		2
