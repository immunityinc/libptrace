...
# core.py
#
# Sample script demonstrating multiple (per thread) event loops.
#
...
parser = argparse.ArgumentParser(description='Multiple cores demonstration script.')
...
threading.Thread(target=core_handler, args=(args,)).start()
core_handler(args)
